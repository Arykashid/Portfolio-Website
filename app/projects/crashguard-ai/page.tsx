    ...
    <div className="min-h-screen bg-[#121315] text-[#e3e2e5] flex flex-col">
      ...
      <main className="w-full pt-28 sm:pt-28 pb-28 sm:pb-36 flex-1">
        <div className="max-w-[1320px] mx-auto px-5 sm:px-8 lg:px-16 flex flex-col gap-12 sm:gap-16">
          ...
          <div id="overview" className="flex flex-col gap-6 scroll-mt-[5.5rem]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
            ...
            <div className="lg:col-span-8 flex flex-col gap-8">
              <div id="architecture" className="flex items-center gap-2 scroll-mt-[5.5rem]">
              ...
              <div id="benchmarks" className="p-6 sm:p-7 rounded-2xl bg-[#1b1c1e] border border-[#444749]/30 shadow-lg flex flex-col gap-6 scroll-mt-[5.5rem]">
            ...
            <div className="lg:col-span-4 flex flex-col gap-6">
              {/* Tech Stack Box */}
              <div id="tech-stack" className="p-6 sm:p-7 rounded-2xl bg-[#1b1c1e] border border-[#444749]/30 shadow-lg flex flex-col gap-6 scroll-mt-[5.5rem]">
